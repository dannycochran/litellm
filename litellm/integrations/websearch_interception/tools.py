...
def is_web_search_tool(tool: Dict[str, Any]) -> bool:
    ...
    # client-side builtin (e.g. Claude Desktop) that should be left alone
    # so the client's own tool handler runs and makes the standalone
    # `web_search_20250305` sub-request, which short-circuit handles.
    return False
